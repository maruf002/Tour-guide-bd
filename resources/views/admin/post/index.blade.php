                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <td class="text-center">
                                    ...
                                    <a href="{{ route('admin.post.show',$pl->id)}}" class="btn btn-info">
                                    <i class="material-icons">visibility</i>

                                    </a>
                                    <a href="{{ route('admin.post.edit',$pl->id)}}" class="btn btn-info">
                                ...
                                <form id="delete-form-{{$pl->id}}" action="{{ route('admin.post.destroy',$pl->id) }}" method="POST" style="display: none;">
                                      @csrf
                                      @method('DELETE')
                                    </form>
                            </td>
