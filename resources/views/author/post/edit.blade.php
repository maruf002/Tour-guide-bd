...
<form action="{{route('author.post.update',$place->id)}}" method="Post" enctype="multipart/form-data"> 
    @csrf
    @method('put')
{{-- first row  --}}
        ...
        <div class="card">
            <div class="header">
                ...
                <select name="Division" class="form-control search-slt" id="exampleFormControlSelect1">
                   ...
                   <option 
                   {{-- @foreach ($dv as $d)
                   {{$d->id == $div->id ? 'selected' : '' }}
                   @endforeach --}}
                   value="{{$div->id}}">{{$div->bn_name}}</option>
                   @endforeach
                </select>
               <br> <br>
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
              ...
              <textarea id="tinymce" name="body">{{$place->description}}</textarea>
